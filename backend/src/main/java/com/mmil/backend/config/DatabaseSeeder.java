...
public class DatabaseSeeder {
    ...
    private void seedResourceFoldersAndItems(User admin, ResourceFolderRepository folderRepository, ResourceItemRepository itemRepository) {
        ...
        ResourceFolder webDev = folderRepository.findByName("Web Development & Frontend")
                .orElseGet(() -> {
                    ...
                    f.setDescription("Curated guides, roadmaps, and cheat sheets for modern Web Architecture, React, and Next.js.");
        ...
        ResourceFolder backendDev = folderRepository.findByName("Backend & Systems")
                .orElseGet(() -> {
                    ...
                    f.setDescription("Deep dive into Spring Boot, Node.js, Microservices, Databases, and Docker containers.");
                    return folderRepository.save(f);
                });
        ...
        ResourceFolder aiMl = folderRepository.findByName("AI & Machine Learning")
                .orElseGet(() -> {
                    ...
                    f.setDescription("Roadmaps, datasets, PyTorch guides, and prompt engineering resources for developers.");
                    return folderRepository.save(f);
                });
        ...
        ResourceFolder cpDsa = folderRepository.findByName("DSA & Interview Prep")
                .orElseGet(() -> {
                    ...
                    f.setDescription("Problem sets, algorithm visualizers, patterns, and technical interview roadmaps.");
                    return folderRepository.save(f);
                });
        ...
        ResourceFolder mobileDev = folderRepository.findByName("Mobile App Development")
                .orElseGet(() -> {
                    ...
                    f.setDescription("Cross-platform and native mobile app development guides for Flutter, React Native, and Android.");
                    return folderRepository.save(f);
                });
        ...
        ResourceFolder cyberSec = folderRepository.findByName("Cybersecurity & DevOps")
                .orElseGet(() -> {
                    ...
                    f.setDescription("Security best practices, OWASP top 10, network security, and CI/CD automation pipelines.");
                    return folderRepository.save(f);
                });
    ...
    private void seedItemIfMissing(ResourceFolder folder, String title, String description, List<String> techStack, String url, User admin, ResourceItemRepository itemRepository) {
    ...
    private void seedEvents(EventRepository eventRepository) {
        // Zealicon Events
        seedEventIfMissing(eventRepository, "Logocon", "logocon", "Zealicon flagship logic and coding contest.", "event", "completed", false, 1, 1);
        seedEventIfMissing(eventRepository, "Code-in-Pair", "code-in-pair", "Two-member team coding relay contest.", "event", "completed", true, 2, 2);
        seedEventIfMissing(eventRepository, "Decode", "decode", "Cryptic hunt and algorithmic decoding event.", "event", "completed", false, 1, 1);
        seedEventIfMissing(eventRepository, "Valorant Gaming Tournament", "valorant", "Zealicon e-sports Valorant tournament.", "event", "completed", true, 5, 5);

        // Society Flagship Events
        seedEventIfMissing(eventRepository, "Hack-o-Code", "hack-o-code", "Annual Coding Contest.", "event", "completed", false, 1, 1);
        seedEventIfMissing(eventRepository, "GitHub & Version Control Workshop", "github-workshop", "Learn Git basics and open-source contribution.", "workshop", "completed", false, 1, 1);
        seedEventIfMissing(eventRepository, "LinkedIn & Resume Building", "resume-workshop", "Professional profile optimization session.", "workshop", "completed", false, 1, 1);
        seedEventIfMissing(eventRepository, "Generative AI & Python", "genai-workshop", "Learn prompt engineering and Python.", "workshop", "completed", false, 1, 1);
        seedEventIfMissing(eventRepository, "Web Dev & Core Programming Bootcamp", "webdev-bootcamp", "Comprehensive web development crash course.", "workshop", "completed", false, 1, 1);
    }

    private void seedEventIfMissing(EventRepository repo, String title, String slug, String desc, String type, String status, boolean isTeam, int min, int max) {
